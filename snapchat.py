...
if Q1 == "no": 
	...
	for line in Lines:
	    ...
	    if checker.status_code == 200:
	    	print(detect_color+"unavailable ==> "+ f"https://www.snapchat.com/add/"+ usercheck)
	    else:
	    	print(green_color+"available ==> "+ f"https://www.snapchat.com/add/"+ usercheck)
	print("\n")
	print("\n")
	...
	if checker2.status_code == 200:
		print(detect_color+"unavailable ==> "+ f"https://www.snapchat.com/add/"+ UserfromClint)
		print("\n")
		print("\n")
		print(detect_color + "Message From Abu Layan")
		print(green_color + "Thanks For Useing My Script \n Bye")
	else:
		print(green_color+"available ==> "+ f"https://www.snapchat.com/add/"+ UserfromClint)
		print("\n")
		print("\n")
		print(detect_color + "Message From Abu Layan")
		print(green_color + "Thanks For Useing My Script \n Bye")
